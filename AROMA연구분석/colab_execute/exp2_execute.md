...
**런타임**: CPU (GPU 불필요)  
**전제**: Step 3 및 Step 4가 6개 데이터셋(mvtec_cable, mvtec_pill, mvtec_wood, mvtec_metal_nut, visa_cashew, severstal)에서 완료된 상태
...
6개 데이터셋에 대해 `--sampling_strategy random`으로 ROI를 선택한다.  
