...
**Manuscript changes:** offending sentence removed and Eq. (2) corrected to the three-component score (§3.2.4); new sensitivity subsection (§4.5); new ablation study (§4.4, Table 11); CASDA provenance of Eq. (4) weights stated in §3.2.6.
