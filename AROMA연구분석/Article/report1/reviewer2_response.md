...
**Manuscript changes:** Eq. (2) corrected to the three-component score with an explicit fixed-design-choice statement and sensitivity summary (§3.2.4); §3.2.6 states the CASDA provenance of the quality-gate weights; new sensitivity subsection (§4.5); data-derived partition descriptions in §3.2.2–3.2.3.
